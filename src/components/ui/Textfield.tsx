...
export function Textfield(props: TextfieldProps) {
  ...
  return (
    <TextField.Root {...rest}>
      ...
      <TextField.Input
        ref={props.ref}
        class="bg-background px-2 py-2 h-10 w-full rounded-md border border-input focus-visible:(outline-none ring-offset-2 ring-ring ring-2) placeholder:text-muted-foreground disabled:opacity-50"
      />
    </TextField.Root>
  );
}
